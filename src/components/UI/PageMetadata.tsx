...
export const PageMetadata: FC<Props> = ({ title, description }) => {
  ...
  return (
    <Head>
      ...
      <meta name='image' content='https://security.ethereum.org/images/ef-logo-bg-white.png' />
      {/* OpenGraph */}
      <meta property='og:title' content={`${title} | ${HEAD_TITLE}`} />
      <meta property='og:description' content={description} />
      <meta property='og:type' content='website' />
      <meta property='og:site_name' content={HEAD_TITLE}></meta>
      <meta property='og:url' content='https://security.ethereum.org/' />
      <meta property='og:image' content='https://security.ethereum.org/images/ef-logo-bg-white.png' />
      <meta
        property='og:image:url'
        content='https://security.ethereum.org/images/ef-logo-bg-white.png'
      />
      <meta
      ...
      <meta property='twitter:url' content='https://security.ethereum.org/' />
